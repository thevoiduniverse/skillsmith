  ...
  return (
    <div className="relative flex min-h-screen bg-[#0a0a0a]">
      ...
      <div className="relative z-10 flex-1 flex flex-col min-w-0">
        {/* Header */}
        <div className="flex flex-wrap items-center justify-between gap-2 px-4 md:px-6 min-h-[56px] py-2 border-b border-border pt-[calc(env(safe-area-inset-top,0px)+8px)]">
          <Link
            href="/"
          ...
          <Link
            href="/signup"
            className="inline-flex items-center justify-center font-bold rounded-[40px] text-xs px-4 py-2 bg-accent text-[#0a0a0a] hover:brightness-110 transition-all whitespace-nowrap w-full md:w-auto"
          >
            Sign Up Free
          </Link>
        </div>
